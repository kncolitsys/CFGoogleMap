...
<body onunload="GUnload()">
	...
	<div style="width:700px;height:300px">
		...
		<cfset variables.sArgs.address1 = "3075 E. Merrill Ave">
		<cfset variables.sArgs.city	= "Gilbert">
		<cfset variables.sArgs.state = "AZ">
		<cfset variables.sArgs.postalCode = "85234">
		<cfset variables.sArgs.countryCode = "US">
