...
<body onunload="GUnload()">
	<h1>Example 9 - Including the overview map</h1>
	<p><a href="documentation.htm">Documentation</a> | <a href="source.cfm?source=9">View Source</a></p>
	<div style="width:700px;height:300px">
		<gm:googlemap width="500" height="300" key="#Application.GoogleMapKey#" maptype="map" fitPointsToMap="true" overviewmap="true" overviewmapwidth="200" overviewmapheight="150">
